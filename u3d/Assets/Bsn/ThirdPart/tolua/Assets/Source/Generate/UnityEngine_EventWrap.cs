...
public class UnityEngine_EventWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", _CreateUnityEngine_Event);
	...
	static int _CreateUnityEngine_Event(IntPtr L)
	{
		try
		{
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Event)))
			{
	...
	static int get_mousePosition(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index mousePosition on a nil value" : e.Message);
		}
	}
	...
	static int get_control(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index control on a nil value" : e.Message);
		}
	}
	...
	static int get_command(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index command on a nil value" : e.Message);
		}
	}
	...
	static int get_capsLock(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index capsLock on a nil value" : e.Message);
		}
	}
	...
	static int get_numeric(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index numeric on a nil value" : e.Message);
		}
	}
	...
	static int get_functionKey(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index functionKey on a nil value" : e.Message);
		}
	}
	...
	static int get_current(IntPtr L)
	{
		try
		{
			ToLua.PushObject(L, UnityEngine.Event.current);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_isKey(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isKey on a nil value" : e.Message);
		}
	}
	...
	static int get_isMouse(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isMouse on a nil value" : e.Message);
		}
	}
	...
	static int get_rawType(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index rawType on a nil value" : e.Message);
		}
	}
	...
	static int get_pressure(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index pressure on a nil value" : e.Message);
		}
	}
	...
	static int get_displayIndex(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index displayIndex on a nil value" : e.Message);
		}
	}
