...
public class UnityEngine_Rigidbody2DWrap
{
	...
	static int IsTouchingLayers(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
				bool o = obj.IsTouchingLayers();
				LuaDLL.lua_pushboolean(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D), typeof(int)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
	...
	static int AddForce(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D), typeof(UnityEngine.Vector2)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
				UnityEngine.Vector2 arg0 = ToLua.ToVector2(L, 2);
				obj.AddForce(arg0);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D), typeof(UnityEngine.Vector2), typeof(UnityEngine.ForceMode2D)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
				UnityEngine.Vector2 arg0 = ToLua.ToVector2(L, 2);
				UnityEngine.ForceMode2D arg1 = (UnityEngine.ForceMode2D)ToLua.ToObject(L, 3);
	...
	static int AddForceAtPosition(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D), typeof(UnityEngine.Vector2), typeof(UnityEngine.Vector2)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
				UnityEngine.Vector2 arg0 = ToLua.ToVector2(L, 2);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D), typeof(UnityEngine.Vector2), typeof(UnityEngine.Vector2), typeof(UnityEngine.ForceMode2D)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
				UnityEngine.Vector2 arg0 = ToLua.ToVector2(L, 2);
				UnityEngine.Vector2 arg1 = ToLua.ToVector2(L, 3);
				UnityEngine.ForceMode2D arg2 = (UnityEngine.ForceMode2D)ToLua.ToObject(L, 4);
	...
	static int AddTorque(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D), typeof(float)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Rigidbody2D), typeof(float), typeof(UnityEngine.ForceMode2D)))
			{
				UnityEngine.Rigidbody2D obj = (UnityEngine.Rigidbody2D)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.ForceMode2D arg1 = (UnityEngine.ForceMode2D)ToLua.ToObject(L, 3);
	...
	static int get_useAutoMass(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index useAutoMass on a nil value" : e.Message);
		}
	}
	...
	static int get_gravityScale(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index gravityScale on a nil value" : e.Message);
		}
	}
	...
	static int get_simulated(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index simulated on a nil value" : e.Message);
		}
	}
	...
	static int get_sleepMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index sleepMode on a nil value" : e.Message);
		}
	}
