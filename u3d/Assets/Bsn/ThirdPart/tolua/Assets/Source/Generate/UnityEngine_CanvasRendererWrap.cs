...
public class UnityEngine_CanvasRendererWrap
{
	...
	static int SetMaterial(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.CanvasRenderer), typeof(UnityEngine.Material), typeof(UnityEngine.Texture)))
			{
				UnityEngine.CanvasRenderer obj = (UnityEngine.CanvasRenderer)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.CanvasRenderer), typeof(UnityEngine.Material), typeof(int)))
			{
				UnityEngine.CanvasRenderer obj = (UnityEngine.CanvasRenderer)ToLua.ToObject(L, 1);
				UnityEngine.Material arg0 = (UnityEngine.Material)ToLua.ToObject(L, 2);
	...
	static int GetMaterial(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.CanvasRenderer)))
			{
				UnityEngine.CanvasRenderer obj = (UnityEngine.CanvasRenderer)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.CanvasRenderer), typeof(int)))
			{
				UnityEngine.CanvasRenderer obj = (UnityEngine.CanvasRenderer)ToLua.ToObject(L, 1);
	...
	static int get_hasRectClipping(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index hasRectClipping on a nil value" : e.Message);
		}
	}
	...
	static int get_hasPopInstruction(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index hasPopInstruction on a nil value" : e.Message);
		}
	}
	...
	static int get_materialCount(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index materialCount on a nil value" : e.Message);
		}
	}
	...
	static int get_popMaterialCount(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index popMaterialCount on a nil value" : e.Message);
		}
	}
	...
	static int get_relativeDepth(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index relativeDepth on a nil value" : e.Message);
		}
	}
	...
	static int get_cull(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index cull on a nil value" : e.Message);
		}
	}
	...
	static int get_absoluteDepth(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index absoluteDepth on a nil value" : e.Message);
		}
	}
	...
	static int get_hasMoved(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index hasMoved on a nil value" : e.Message);
		}
	}
