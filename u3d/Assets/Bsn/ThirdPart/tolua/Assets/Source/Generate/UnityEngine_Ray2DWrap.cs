...
public class UnityEngine_Ray2DWrap
{
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Ray2D)))
			{
				UnityEngine.Ray2D obj = (UnityEngine.Ray2D)ToLua.ToObject(L, 1);
				string o = obj.ToString();
				LuaDLL.lua_pushstring(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Ray2D), typeof(string)))
			{
				UnityEngine.Ray2D obj = (UnityEngine.Ray2D)ToLua.ToObject(L, 1);
