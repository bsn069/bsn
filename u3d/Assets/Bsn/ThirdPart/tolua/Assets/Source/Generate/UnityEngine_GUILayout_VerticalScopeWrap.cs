...
public class UnityEngine_GUILayout_VerticalScopeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UnityEngine.GUILayout.VerticalScope), typeof(UnityEngine.GUI.Scope));
		L.RegFunction("New", _CreateUnityEngine_GUILayout_VerticalScope);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateUnityEngine_GUILayout_VerticalScope(IntPtr L)
	{
		try
		{
			...
			if (TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Texture), typeof(UnityEngine.GUIStyle)) && TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 3, count - 2))
			{
				...
				UnityEngine.GUILayout.VerticalScope obj = new UnityEngine.GUILayout.VerticalScope(arg0, arg1, arg2);
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GUIStyle)) && TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 2, count - 1))
			{
				...
				UnityEngine.GUILayout.VerticalScope obj = new UnityEngine.GUILayout.VerticalScope(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 1, count))
			{
				...
				UnityEngine.GUILayout.VerticalScope obj = new UnityEngine.GUILayout.VerticalScope(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UnityEngine.GUILayout.VerticalScope.New");
			}
		}
		catch(Exception e)
		{
