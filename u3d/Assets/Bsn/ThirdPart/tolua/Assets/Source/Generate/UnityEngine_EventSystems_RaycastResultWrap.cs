...
public class UnityEngine_EventSystems_RaycastResultWrap
{
	...
	static int get_sortingLayer(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index sortingLayer on a nil value" : e.Message);
		}
	}
	...
	static int get_worldNormal(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index worldNormal on a nil value" : e.Message);
		}
	}
	...
	static int get_screenPosition(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index screenPosition on a nil value" : e.Message);
		}
	}
	...
	static int set_module(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.EventSystems.RaycastResult obj = (UnityEngine.EventSystems.RaycastResult)o;
			UnityEngine.EventSystems.BaseRaycaster arg0 = (UnityEngine.EventSystems.BaseRaycaster)ToLua.CheckUnityObject(L, 2, typeof(UnityEngine.EventSystems.BaseRaycaster));
			obj.module = arg0;
			ToLua.SetBack(L, 1, obj);
			return 0;
		}
