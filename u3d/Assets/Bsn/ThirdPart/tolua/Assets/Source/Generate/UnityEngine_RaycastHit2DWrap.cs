...
public class UnityEngine_RaycastHit2DWrap
{
	...
	static int get_centroid(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index centroid on a nil value" : e.Message);
		}
	}
	...
	static int get_fraction(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index fraction on a nil value" : e.Message);
		}
	}
