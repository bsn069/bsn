...
public class UnityEngine_GUILayoutUtilityWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetLastRect", GetLastRect);
		L.RegFunction("GetAspectRect", GetAspectRect);
		L.RegFunction("New", _CreateUnityEngine_GUILayoutUtility);
	...
	static int GetRect(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GUIContent), typeof(UnityEngine.GUIStyle)))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(float), typeof(float), typeof(UnityEngine.GUIStyle)))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
			...
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(float), typeof(float), typeof(float), typeof(float), typeof(UnityEngine.GUIStyle)))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(float), typeof(float), typeof(float), typeof(float), typeof(UnityEngine.GUIStyle)) && TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 6, count - 5))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(float), typeof(float), typeof(UnityEngine.GUIStyle)) && TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 4, count - 3))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.GUIStyle arg2 = (UnityEngine.GUIStyle)ToLua.ToObject(L, 3);
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(float), typeof(float)) && TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 3, count - 2))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.GUILayoutOption[] arg2 = ToLua.ToParamsObject<UnityEngine.GUILayoutOption>(L, 3, count - 2);
	...
	static int GetAspectRect(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(float)))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(float), typeof(UnityEngine.GUIStyle)))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
				UnityEngine.GUIStyle arg1 = (UnityEngine.GUIStyle)ToLua.ToObject(L, 2);
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(float), typeof(UnityEngine.GUIStyle)) && TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 3, count - 2))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
				UnityEngine.GUIStyle arg1 = (UnityEngine.GUIStyle)ToLua.ToObject(L, 2);
				UnityEngine.GUILayoutOption[] arg2 = ToLua.ToParamsObject<UnityEngine.GUILayoutOption>(L, 3, count - 2);
			...
			else if (TypeChecker.CheckTypes(L, 1, typeof(float)) && TypeChecker.CheckParamsType(L, typeof(UnityEngine.GUILayoutOption), 2, count - 1))
			{
				float arg0 = (float)LuaDLL.lua_tonumber(L, 1);
