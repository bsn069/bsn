...
public class UnityEngine_Networking_Match_CreateMatchResponseWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UnityEngine.Networking.Match.CreateMatchResponse), typeof(UnityEngine.Networking.Match.BasicResponse));
		L.RegFunction("ToString", ToString);
		L.RegFunction("Parse", Parse);
		L.RegFunction("New", _CreateUnityEngine_Networking_Match_CreateMatchResponse);
	...
	static int _CreateUnityEngine_Networking_Match_CreateMatchResponse(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UnityEngine.Networking.Match.CreateMatchResponse obj = new UnityEngine.Networking.Match.CreateMatchResponse();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UnityEngine.Networking.Match.CreateMatchResponse.New");
			}
		}
		catch(Exception e)
		{
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Networking.Match.CreateMatchResponse obj = (UnityEngine.Networking.Match.CreateMatchResponse)ToLua.CheckObject(L, 1, typeof(UnityEngine.Networking.Match.CreateMatchResponse));
	...
	static int get_address(IntPtr L)
	{
		...
		try
		{
			...
			UnityEngine.Networking.Match.CreateMatchResponse obj = (UnityEngine.Networking.Match.CreateMatchResponse)o;
