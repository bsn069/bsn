...
public class UnityEngine_Networking_Match_CreateDedicatedMatchResponseWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UnityEngine.Networking.Match.CreateDedicatedMatchResponse), typeof(UnityEngine.Networking.Match.BasicResponse));
		L.RegFunction("Parse", Parse);
		L.RegFunction("New", _CreateUnityEngine_Networking_Match_CreateDedicatedMatchResponse);
	...
	static int _CreateUnityEngine_Networking_Match_CreateDedicatedMatchResponse(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UnityEngine.Networking.Match.CreateDedicatedMatchResponse obj = new UnityEngine.Networking.Match.CreateDedicatedMatchResponse();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UnityEngine.Networking.Match.CreateDedicatedMatchResponse.New");
			}
		}
		catch(Exception e)
		{
	...
	static int Parse(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Networking.Match.CreateDedicatedMatchResponse obj = (UnityEngine.Networking.Match.CreateDedicatedMatchResponse)ToLua.CheckObject(L, 1, typeof(UnityEngine.Networking.Match.CreateDedicatedMatchResponse));
	...
	static int get_networkId(IntPtr L)
	{
		...
		try
		{
			...
			UnityEngine.Networking.Match.CreateDedicatedMatchResponse obj = (UnityEngine.Networking.Match.CreateDedicatedMatchResponse)o;
