...
public class UnityEngine_Color32Wrap
{
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Color32)))
			{
				UnityEngine.Color32 obj = (UnityEngine.Color32)ToLua.ToObject(L, 1);
				string o = obj.ToString();
				LuaDLL.lua_pushstring(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Color32), typeof(string)))
			{
				UnityEngine.Color32 obj = (UnityEngine.Color32)ToLua.ToObject(L, 1);
